...
class mmovement extends CI_Model {
	...
	public function hdr($field,$fromdate,$todate,$qhour)
	 {
  		$arr = array();
		$sql = "EXEC spGetDataMovement 'All', '$fromdate', '$todate','All' ,'0'";
...
*/
	...
	public function srchdr($fromdate,$todate,$statussage,$qhour, $ssource)
	 {
        ...
        {$qhour = "'All'";}
			  $sql = "EXEC spGetDataMovement ".$locimp.", '$fromdate', '$todate',".$qhour." ,".$sage."";
			  $query = $this->db->query($sql);
	...
	public function dtl($qProdCode,$qPO,$qLot,$Loc_From,$fromdate,$Loc_Dest,$statussage,$qhour,$ssource)
	 {
  		$arr = array();
		  if ($statussage==2)
		{
		...
		from trnMovement as a left join mFabricRoll as b on a.QRNumber = b.QRNumber where b.qProdCode='$qProdCode' and b.qPO='$qPO' and b.qLot='$qLot' and a.Loc_From = '$Loc_From' and a.Loc_Dest = '$Loc_Dest' and (a.movedate = '$fromdate') ". $statussage1 . " and format(a.movetime,'HH')  = '$qhour'and qLocImport = '$ssource' ");
