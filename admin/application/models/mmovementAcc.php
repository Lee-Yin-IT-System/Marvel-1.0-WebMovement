...
class mmovementAcc extends CI_Model {
	...
	public function hdr($field,$fromdate,$todate,$qhour)
	 {
  		$arr = array();
				$sql = "EXEC spGetDataMovementAcc 'All', '$fromdate', '$todate','All' ,'0'";
...
*/
	...
	public function srchdr($fromdate,$todate,$statussage,$qhour, $ssource)
	 {
  		$arr = array();
        ...
        {$qhour = "'All'";}
			  $sql = "EXEC spGetDataMovementAcc ".$locimp.", '$fromdate', '$todate',".$qhour." ,".$sage."";
	...
	public function dtl($qProdCode,$qPO,$Loc_From,$fromdate,$Loc_Dest,$statussage,$qhour,$ssource)
	 {
  		$arr = array();
		  if ($statussage==2)
		{
		...
		$query = $this->db->query("select a.OnSite,a.MoveDate,format(a.movetime,'HH') as qHour,a.QRNumber,a.Bluebin_from,a.Bluebin_to,a.Loc_From,a.Loc_Dest,a.QtyYard,a.QtyKgs,a.Qty,a.MoveBy,a.MoveDate,b.qLinkGrn
		from trnMovement as a left join mAccessories as b on a.QRNumber = b.QRNumber where b.qProdCode='$qProdCode' and b.qPO='$qPO'  and a.Loc_From = '$Loc_From' and a.Loc_Dest = '$Loc_Dest' and (a.movedate = '$fromdate') ". $statussage1 . " and format(a.movetime,'HH')  = '$qhour' and qLocImport = '$ssource' ");
	...
	public function loadqrnumber($qProdCode,$qPO,$Loc_Dest,$SageMoveId,$tgl,$qhour,$Loc_From)
	 {
  		$arr = array();

		$QRNumber='';
		$query = $this->db->query("select a.QRNumber, a.SageMoveId,a.SageStatus 
		from trnMovement as a inner join mAccessories as b on a.QRNumber = b.QRNumber where b.qProdCode='$qProdCode' and b.qPO='$qPO'  and a.Loc_Dest = '$Loc_Dest'  and Loc_Dest <> Loc_From and format(movetime,'HH') = '$qhour'");
	...
	public function loadqrnumber0($qProdCode,$qPO,$Loc_Dest,$SageMoveId)
	 {
  		$arr = array();

		$QRNumber='';
		$query = $this->db->query("select a.QRNumber, a.SageMoveId,a.SageStatus 
		from trnMovement as a left join mAccessories as b on a.QRNumber = b.QRNumber where b.qProdCode='$qProdCode' and b.qPO='$qPO' and  and a.Loc_Dest = '$Loc_Dest' and Loc_Dest <> Loc_From");
